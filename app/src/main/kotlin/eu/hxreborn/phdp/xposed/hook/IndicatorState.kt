...
object IndicatorState {
    ...
    @Volatile
    var gradientColors = decodeGradientColors(Prefs.gradientColors.default).toIntArray()
        private set
    ...
    private fun refreshCacheForKey(
        ...
        runCatching {
            when (key) {
                ...
                Prefs.gradientColors.key -> {
                    gradientColors =
                        decodeGradientColors(Prefs.gradientColors.read(prefs)).toIntArray()
                }
