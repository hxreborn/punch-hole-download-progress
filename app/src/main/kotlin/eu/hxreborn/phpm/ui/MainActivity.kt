...
import eu.hxreborn.phpm.PunchHoleMonitorApp
import eu.hxreborn.phpm.R
import eu.hxreborn.phpm.prefs.PrefsManager
import eu.hxreborn.phpm.ui.state.rememberPrefsState
import eu.hxreborn.phpm.ui.theme.AppTheme
import eu.hxreborn.phpm.util.RootUtils
...
class MainActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PunchHoleMonitorApp.addServiceListener(this)

        setContent {
            AppTheme {
                val prefsState by rememberPrefsState(prefs)

                PunchHoleMonitorAppContent(
    ...
    override fun onDestroy() {
        super.onDestroy()
        PunchHoleMonitorApp.removeServiceListener(this)
    }
